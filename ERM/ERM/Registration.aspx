...
<asp:Content ID="MyContent" ContentPlaceHolderID="MyContentPlaceHolder" runat="server">
    ...
    <asp:Button ID="btnSubmit" CssClass="btn btn-dark" runat="server" Text="SUBMIT" OnClick="btnSubmit_Click" />&nbsp;&nbsp;<asp:LinkButton ID="btnCancel" runat="server" OnClick="btnCancel_Click">CANCEL</asp:LinkButton>
